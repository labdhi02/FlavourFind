...
const App = () => {
  ...
  const handleSearch = () => {
    ...
    const filtered = recipes.filter((recipe: Recipe) =>
      recipe["TranslatedRecipeName"].toLowerCase().includes(searchQuery.toLowerCase()) ||
      recipe["Cleaned-Ingredients"].toLowerCase().includes(searchQuery.toLowerCase())
    );
  ...
  const handleSave = async (recipe: Recipe) => {
    try {
      ...
      //Alert.alert("Success", "Recipe has been saved! ✅");
      setSaveMessage("Recipe has been saved! ✅");
